...
namespace Micro.Sinhro.REST.APIGateway.Controllers
{
    ...
    public class GiftController : ControllerBase
    {
        ...
        {
            var response = httpClient.GetAsync(url.Gift + "/Gift").Result;
        ...
        {
            var response = httpClient.GetAsync(url.Gift + "/Gift/" + id).Result;
            response.EnsureSuccessStatusCode();
        ...
        {
            var response = httpClient.DeleteAsync(url.Gift + "/Gift/" + id).Result;
            response.EnsureSuccessStatusCode();
        ...
        public async Task<IActionResult> CreateGift([FromForm] CreateRequest gift)
        {
            using (var formData = new MultipartFormDataContent())
            {
                ...
                var response = httpClient.PostAsync(url.Gift + "/Gift", formData).Result;
                 response.EnsureSuccessStatusCode();
        ...
        public async Task<IActionResult> UpdateGift([FromForm] UpdateRequest request, int id)
        {
            using (var formData = new MultipartFormDataContent())
            {
                ...
                var response = httpClient.PutAsync(url.Gift + "/Gift/" + id, formData).Result;
                response.EnsureSuccessStatusCode();
